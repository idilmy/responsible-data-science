...
# Define and calibrate Random Forest
...
print(f"Random Forest - Brier Score (Calibration Check): {brier:.4f}")

# Plot SHAP summary
rf_trained_model = calibrated_rf.calibrated_classifiers_[0].estimator
explainer = shap.Explainer(rf_trained_model, X_train)
